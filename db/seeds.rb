...
alice_comment_4 = Comment.create(post: oscar_post_9, user: alice, text: 'Alice\'s fourth comment', created_at: 2.days.ago)
...
linda_comment_6 = Comment.create(post: oscar_post_9, user: linda, text: 'Linda\'s sixth comment', created_at: 2.days.ago)
...
Like.create(post: oscar_post_9, user: tom, created_at: 4.days.ago)
Like.create(post: oscar_post_9, user: alice, created_at: 4.days.ago)
Like.create(post: oscar_post_9, user: linda, created_at: 2.days.ago)
